...
export default function projects() {
  return (
    <main>
      <p className="mt-11 flex flex-col items-center gap-5">
      ...
      <p className=" text-siz mt-6 flex flex-col items-center gap-5">
      ...
      <p>
        Artsy, is the title of my newest project that is currenly a work in
        progress!
      </p>
      <figure></figure>
    </main>
